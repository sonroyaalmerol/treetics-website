...
export default function TreeticsFrontend(props) {
  ...
  return (
    <React.Fragment>
      <Head>
        { routeObject ?
          <>
            <title>{routeObject.title} - Treetics</title>
            <meta name="description" content={routeObject.desc} />
            <meta name="twitter:card" value="summary" />
            <meta name="twitter:image" content="/treetics-seo-twitter-default.png" />
            <meta property="og:title" content={routeObject.title} />
            <meta property="og:type" content="website" />
            <meta property="og:image" content="/treetics-seo-default.png" />
            <meta property="og:url" content={`${frontendURL}${routeObject.href}`} />
            <meta property="og:description" content={routeObject.desc} />
          </>
          : <title>Treetics</title> }
        <meta name="description" content="Treetics Official Website" />
        <meta
          name="viewport"
